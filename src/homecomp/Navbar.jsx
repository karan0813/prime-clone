...
const Navbar = () => {
    ...
    return (
        <>
            <div className="w-full h-20 bg-[#19232D] flex items-center justify-between">
                <div className="flex items-center ">
                    ...
                    {!Catag ? <svg xmlns="http://www.w3.org/2000/svg" onClick={() => { setCatag(true) }} className="h-5 w-5 text-white md:hidden" viewBox="0 0 20 20" fill="currentColor">
                        ...
                        : <svg xmlns="http://www.w3.org/2000/svg" onClick={() => { setCatag(false) }} className="h-5 w-5 md:hidden text-white " viewBox="0 0 20 20" fill="currentColor">
                ...
                <div className=" ">
                    <div className="flex items-center space-x-3 pr-6 ">
                        <div className="lg:border lg:border-gray-400 flex p-2">
                            <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 md:block lg:block hidden
            ...
            {/* catg */}
            {Catag ? <div>
                <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 mr-7 m-3 text-white" onClick={() => { setCatag(false) }} fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            {enter ? <Categories setenter={setenter} setCatag={setCatag} /> : ""}
