...
const Channels = () => {
    return <div className="lg:flex md:flex  h-fit px-12 py-8">
        ...
        <div className="grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 mt-4	">
            ...
            <div className='mr-2'><img className="object-contain w- pb-2 lg:hover:h-36 ease-in duration-300  w-full md:h-32" src='https://m.media-amazon.com/images/G/31/AmazonVideo/2021/Channels/MLP/LionsgatePlay-426X2946_V1.jpg' alt='...' /></div>
            <div className='mr-2'><img className="object-contain w- pb-2 lg:hover:h-36 ease-in duration-300  w-full md:h-32" src='https://m.media-amazon.com/images/G/31/AmazonVideo/2021/Channels/MLP/LionsgatePlay-426X2946_V1.jpg' alt='...' /></div>
            <div className='mr-2'><img className="object-contain w- pb-2  lg:hover:h-36 ease-in duration-300 w-full md:h-32" src='https://m.media-amazon.com/images/G/31/AmazonVideo/2021/Channels/MLP/LionsgatePlay-426X2946_V1.jpg' alt='...' /></div>
            <div className='mr-2'><img className="object-contain w- pb-2 lg:hover:h-36 ease-in duration-300 w-full md:h-32" src='https://m.media-amazon.com/images/G/31/AmazonVideo/2021/Channels/MLP/LionsgatePlay-426X2946_V1.jpg' alt='...' /></div>
            <div className='mr-2'><img className="object-contain w- pb-2  lg:hover:h-36 ease-in duration-300 w-full md:h-32" src='https://m.media-amazon.com/images/G/31/AmazonVideo/2021/Channels/MLP/LionsgatePlay-426X2946_V1.jpg' alt='...' /></div>
