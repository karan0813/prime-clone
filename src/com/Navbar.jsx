...
const Navbar = () => {
    ...
    return <>
        <nav className="bg-[#19232D] w-screen h-18 sticky top-0 ">
            <div className="flex justify-between w-full items-center px-8">
                ...
                <div className=" md:flex  items-center space-x-1 hidden  relative md:-right-56 lg:-right-96 ">
                ...
                <Link to="/login"><svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-gray-400  md:hidden" fill="none" viewBox="0 0 24 24" stroke="currentColor">
