        ...
        <div className="flex flex-col justify-center items-center">
            ...
            <div className="flex flex-col border-gray-300 border-2 p-5 bg-[#FFFFFF]  h-4/5 w-1/4">
                ...
                <form className="flex flex-col ">
                    ...
                    <button className="px-5 w-full py-1 border bg-[#F1C862] rounded-md" onClick={signin}>Sign In</button>
                </form>
                ...
                <hr className="my-4" />
                <button className="px-5 w-full py-1 border-2 bg-[#E9EBEE] rounded-md" onClick={register} >Create-account</button>
            </div >
